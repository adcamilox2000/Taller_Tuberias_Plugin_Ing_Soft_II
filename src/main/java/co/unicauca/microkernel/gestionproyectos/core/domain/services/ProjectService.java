...
public class ProjectService {
    ...
    public void registerProject(String title, String description, User empresa) {
        ...
        try {
            ...
            System.out.println("Proyecto registrado con exito: " + proyecto.getTitle());
        } catch (Exception e) {
            System.out.println("Error no se pudo registrar el proyecto: " + e.getMessage());
        }
    }
    ...
    public void assignProject(String titulo, User estudiante) {
        ...
        if (proyecto == null) {
            System.out.println("No se encontro el proyecto Proyecto. ");
            return;
        }
        proyecto.assignStudent(estudiante);
        System.out.println("EL Proyecto fue asignado a: " + estudiante.getName());
    }
}
